...
namespace Builder
{
    class Program
    {
        ...
        {
            public override void BuildDough() { pizza.SetDough("soft"); }
            public override void BuildSauce() { pizza.SetSauce("warm"); }
            public override void BuildTopping() { pizza.SetTopping("egg+tomatos"); }
        }
        /** "Director" */
        class Waiter
        {
